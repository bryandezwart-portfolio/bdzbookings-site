  ...
  return (
    <>
      <div className="relative z-10 -mt-14 px-6">
        <div className="mx-auto flex max-w-4xl flex-col gap-4 rounded-3xl border border-goud/40 bg-zwart/85 px-6 py-6 shadow-2xl backdrop-blur-md sm:flex-row sm:items-center">
          <label htmlFor="zoek" className="shrink-0 text-sm font-bold uppercase tracking-[0.2em] text-goud">Zoek een act</label>
